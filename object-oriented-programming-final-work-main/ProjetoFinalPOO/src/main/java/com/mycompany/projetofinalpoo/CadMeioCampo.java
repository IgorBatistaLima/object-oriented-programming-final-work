 ...
 * @author IGOR BATISTA
 */
public class CadMeioCampo extends javax.swing.JFrame {

    static Object getcadMc() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    private MeioCampo a = new MeioCampo();
    
    private static CadMeioCampo unicadMc;
    
    public static CadMeioCampo getCadMc() {
        if (unicadMc == null) {
            unicadMc = new CadMeioCampo();
        }
        return unicadMc;
    }
    /**
     * Creates new form cadMc
     */
    public CadMeioCampo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        rotAssistencias = new javax.swing.JLabel();
        cxAssistencias = new javax.swing.JTextField();
        cxPassLongo = new javax.swing.JTextField();
        rotPassLongo = new javax.swing.JLabel();
        ...
        rotAssistencias.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        rotAssistencias.setText("ASSISTENCIAS");
        rotAssistencias.setAlignmentX(0.5F);
        ...
        cxPassLongo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cxPassLongoActionPerformed(evt);
            }
        });

        rotPassLongo.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        rotPassLongo.setText("PASSES LONGOS");
        rotPassLongo.setAlignmentX(0.5F);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(rotPassLongo, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(cxPassLongo, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(rotAssistencias)
                            .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rotAssistencias, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rotPassLongo)
                    .addComponent(cxPassLongo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(99, 99, 99)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnCadastrar)
                    .addComponent(btnConsultar)
    ...
    private void cxPassLongoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cxPassLongoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cxPassLongoActionPerformed

   public void excMcNum(){
       a = new MeioCampo();
       a.setNumCamisa(Integer.parseInt(cxNumCamisa.getText()));
       
       a = BancoMeioCampo.getBancoMeioCampo().delMcNum(a);
       ...
       if(a != null){
           JOptionPane.showMessageDialog(
            ...
            JOptionPane.showMessageDialog(
                null,
                "MeioCampo EXCLUIDO com sucesso",
     ...
     *
     */
    public void consMcNum(){
        
        a = new MeioCampo();
        a.setNumCamisa(Integer.parseInt(cxNumCamisa.getText()));
         
        a = BancoMeioCampo.getBancoMeioCampo().consMcNum(a);
        ...
        if(a != null){
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "MeioCampo encontrado com sucesso!",
                    "Consulta de MeioCampo",
                    1
    ...
    public void altMcNum(){
        a = new MeioCampo();
        a.setNumCamisa(Integer.parseInt(cxNumCamisa.getText()));
        
        a = BancoMeioCampo.getBancoMeioCampo().altMcNum(a);
        ...
        if(a != null){
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "MeioCampo alterado com sucesso!",
                    "Alteracao de MeioCampo",
                    1
    ...
    public void insMc(){
        ...
        a.setNumAssistencias(Integer.parseInt(cxAssistencias.getText()));
        a.setPasseLongos(Integer.parseInt(cxPassLongo.getText()));
        
        
        a = BancoMeioCampo.getBancoMeioCampo().cadMc(a);
        
        if(a != null){
            JOptionPane.showMessageDialog(
                    null,
                    "MeioCampo cadastrada com sucesso!",
                    "Cadastro de MeioCampo",
                    1
            );     
        }
        else{
    ...
    private javax.swing.JTextField cxPassLongo;
